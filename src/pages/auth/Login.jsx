...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (loginId.length >= 4 && password.length >= 6) {
      ...
      navigate("/home"); // Navigate to home if credentials are correct
    } else {
  ...
  return (
    <div className="flex min-h-[80vh] justify-center items-center w-[35%]">
      <div className="flex justify-center items-center bg-gradient-to-b from-[#ffffff] to-[#bbbde4] h-[95%] mt-7 w-full mr-[20px] rounded-2xl">
        <form className="flex flex-col gap-y-3 w-[75%]" onSubmit={handleSubmit}>
          {/* Login ID */}
          <div className="flex flex-col gap-y-1">
            ...
            <input
              ...
              className={`border ${
                loginId.length < 4
                  ? "border-gray-400"
                  : loginIdError.includes("good") && !isLoginFailed
